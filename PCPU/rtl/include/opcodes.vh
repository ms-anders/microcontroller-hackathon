...
`define OP_LDB 6'b010100
`define OP_STB 6'b010101

`define OP_POP  6'b010010
`define OP_PUSH 6'b010011
...
`define OP_JSR 6'b011000
`define OP_RET 6'b011001 
